...
BFLAGS	+=	-DCFG_SUPPORT_MTK_SMNT=1
...
FUNCFLAGS	+=	-DATCMD_TCPIP_SUPPORT=1
...
FUNCFLAGS	+=	-DHW_TIMER1_SUPPORT=1
FUNCFLAGS	+=	-DZC_MODULE_VERSION=0 
FUNCFLAGS	+=	-DZC_MODULE_TYPE=1
FUNCFLAGS	+=	-DZC_MODULE_DEV=1
FUNCFLAGS	+=	-DZC_EASY_UART=1
FUNCFLAGS	+=	-DxTEST_ADDR=0
#END-OF-FILE#
